...
delete from cuisine;
delete from region;
delete from moyen_de_payment;
delete from groupe;
delete from groupe_autorisation;
delete from autorisation;
delete from produit;
delete from restaurant;
delete from restaurant_moyen_de_payment;
...
alter table moyen_de_payment auto_increment = 1;
alter table groupe auto_increment = 1;
alter table autorisation auto_increment = 1;
